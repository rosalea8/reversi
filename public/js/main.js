...
/* If we are being notified that we left, then ignore it */
...
/* Update my color (team) */

if(socket.id == payload.game.player_Lannister.socket){
  my_color = 'Lannister';
}
else if(socket.id == payload.game.player_Targaryen.socket){
  my_color = 'Targaryen'
}
else{
